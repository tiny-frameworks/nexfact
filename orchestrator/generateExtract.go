...
func (o *Orchestrator) extract(rJob *job.RenderJob, finalize bool) (renderoutput *writer.RenderOutput, err error) {
	...
	renderInput.OutputPath = filepath.Join(config.SellerParams.SellerRoot, "outputs", "factur-x.xml")
